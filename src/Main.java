...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SubTask subTask1=new SubTask("subtask1", "StDescript1",Status.NEW,epic1);
        SubTask subTask2=new SubTask("subtask2", "StDescript2",Status.NEW,epic1);
        SubTask subTask3=new SubTask("subtask3", "StDescript3",Status.NEW,epic1);

        SubTask subTask4=new SubTask("subtask4", "StDescript4",Status.NEW,epic2);
        SubTask subTask5=new SubTask("subtask5", "StDescript5",Status.NEW,epic2);
        SubTask subTask6=new SubTask("subtask6", "StDescript6",Status.NEW,epic2);

        SubTask subTask7=new SubTask("subtask7", "StDescript4",Status.NEW,epic3);
        SubTask subTask8=new SubTask("subtask8", "StDescript5",Status.NEW,epic3);
        SubTask subTask9=new SubTask("subtask9", "StDescript6",Status.NEW,epic3);
        ///////////////////////////////////////////////////////
        //проверка вывода
        ...
        /////////////////////////////////////////////////////////////////
        //проверка обновления
        SubTask subTask10=new SubTask("subtask10", "StDescript10",Status.IN_PROGRESS,epic1);
        taskManager.addSubTask(subTask10);
        System.out.println();
        System.out.println("вывод обновленных епиков (1 стал прогрес)- "+taskManager.getEpics());

        subTask1=new SubTask("subtask1up", "StDescript1up",Status.DONE, 6, epic1);
        subTask2=new SubTask("subtask2up", "StDescript2up",Status.DONE, 7, epic1);
        subTask3=new SubTask("subtask3up", "StDescript3up",Status.DONE, 8, epic1);
